...
class propagatorTest(unittest.TestCase):
    ...
    def propagate_1D(self, do_plot=False, method='fft', wavelength=1.24e-10, aperture_type='square',
                     aperture_diameter=40e-6, wavefront_length=100e-6, npoints=500, propagation_distance=30.0,
                     normalization=True, show=1, amplitude=(0.0+1.0j)):
    ...
    def test_propagate_1D_fraunhofer_bis(self, do_plot=False):
    ...
    # @unittest.skip("classing skipping")
    def test_propagate_1D_fft(self, do_plot=False):
    ...
    # @unittest.skip("classing skipping")
    def test_propagate_1D_fft_zoom(self, do_plot=False):
    ...
    # @unittest.skip("classing skipping")
    def test_propagate_1D_fresnel_convolution(self, do_plot=False):
    ...
    # @unittest.skip("classing skipping")
    def test_propagate_1D_integral(self, do_plot=False):
        aperture_type="square"
        aperture_diameter = 40e-6
        wavefront_length = 800e-6
        wavelength = 1.24e-10
    ...
    # @unittest.skip("classing skipping")
    def test_propagate_1D_compare_amplitudes(self, do_plot=False):
